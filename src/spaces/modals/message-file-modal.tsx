...
import AudioInput from "@/spaces/ai/audio-input";
...
export const MessageFileModal = () => {
    ...
    // Create a memoized ref handler
    const getInputRef = useCallback(() => {
        return {
            current: textInputRef.current as HTMLTextAreaElement | HTMLDivElement
        };
    }, []);
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormControl>
                                                <FileUpload
                                                    endpoint={MediaCategories.MESSAGE}  // Use MESSAGE instead of MESSAGE_FILE
                                                    value={field.value}
