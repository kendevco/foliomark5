...
import { MediaCategories } from '@/spaces/collections/types'; // Update this import
...
export const InitialModal = () => {
    // The purpose of this is to eliminate hydration mismatch errors.
    // Antonio says that the reason for this is that the Dialog component
    // is notorious for causing hydration mismatches.
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            <FormControl>
                                                <FileUpload
                                                    endpoint={MediaCategories.SPACE}
                                                    value={field.value}
