...
import { ChannelTypes, type ChannelType } from "@/utilities/constants/channels";
...
const formSchema = z.object({
  ...
  type: z.enum([ChannelTypes.TEXT, ChannelTypes.AUDIO, ChannelTypes.VIDEO])
});
...
export const EditChannelModal = () => {
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      name: "",
      type: channel?.type as ChannelType || ChannelTypes.TEXT
    }
  });
  ...
  useEffect(() => {
    if (channel) {
      ...
      form.setValue("type", (channel.type || ChannelTypes.TEXT) as ChannelType);
    }
  }, [form, channel]);
