            ...
            <FormItem>
              <FormControl>
                <div className="relative p-4 pb-6">
                  ...
                  <Textarea
                    disabled={isLoading}
                    className="w-full px-14 py-6 bg-zinc-200/90 dark:bg-zinc-700/75 border-none border-0 focus-visible:ring-0 focus-visible:ring-offset-0 text-zinc-600 dark:text-zinc-200"
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                        ...
                        form.handleSubmit(onSubmit)(); // call handleSubmit directly
                      }
                    }}
                  />
